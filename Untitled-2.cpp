...
String::String(const String & str) {
    if (str.string == NULL) string = NULL;
    else {
...
void String::assign(const char * cstr) {
    clear();
    if (cstr == NULL) cout << "Assiging an empty string";
    else {
    string = new char[length(cstr)];
    for(size_t i = 0; i < length(cstr); i++){
        string[i] = cstr[i];
...
void String::assign(const String & str) {
    clear();    
    if (str.string == NULL) cout << "Assiging an empty string";
    else {
    string = new char[length(str)];
    for(size_t i = 0; i < length(str); i++){
        string[i] = str.at(i);
...
void String::concatenate(const char * cstr) {
    if (cstr == NULL) cout << "Concatenating an empty string";
    else {
    String tstr(string);
    clear();    
...
void String::concatenate(const String & str) {
    if (str.string == NULL) cout << "Concatenating an empty string";
    else {
    String tstr(string);
    clear();    
...
void String::insert(const char * cstr, const int start) {
    if (cstr == NULL) cout << "Inserting an empty string";
    else {
    String tstr(string);
    delete[] string;    
    string = new char[length(tstr)+length(cstr)];
...
void String::insert(const String & str, const int start) {
    if (str.string == NULL) cout << "Inserting an empty string";
    else {
    String tstr(string);
    delete[] string;    
    string = new char[length(tstr)+length(str)];
...
void String::erase(const int start, int end) {
    if(end == 0) end = length(string);
    if (start < 0 || start > length(string) || end < 0 || end > length(string)) cout << "Invalid erase indices";
    else {
    String tstr(string);
    clear();    
...
void String::reverse() {
    if (string == NULL) cout << "Reverseing an empty string";
    else {
...
void String::display() const {
    if(string != NULL) cout << string << endl;
    else cout << "Empty string" << endl;
}

void String::copy(const char * cstr, const int start, int end) {
    if (cstr == NULL) cout << "copying an empty string" << endl;
    else if (start < 0 || start > length(cstr) || end < 0 || end > length(cstr)) cout << "Invalid copy indices" << endl;
    else {
    if(end == 0) {
        end = length(cstr);
    }
...
void String::copy(const int start, const int num, const char * cstr) {
    if (cstr == NULL) cout << "copying an empty string" << endl;
    else if (start < 0 || start > length(cstr) || num < 0 || num > length(cstr)) cout << "Invalid copy indices" << endl;
    else {
    clear();    
    string = new char[num];
...
void String::copy(const String & str, const int start, int end) {
    if (str.string == NULL) cout << "copying an empty string" << endl;
    else if (start < 0 || start > length(str.string) || end < 0 || end > length(str.string)) cout << "Invalid copy indices" << endl;
    else {
    if(end == 0) {
        end = length(str);
    }
...
void String::copy(const int start, const int num, const String & str) {
    if (str.string == NULL) cout << "copying an empty string" << endl;
    else if (start < 0 || start > length(str.string) || num < 0 || num > length(str.string)) cout << "Invalid copy indices" << endl;
    else {
    clear();    
    string = new char[num];
    for(size_t i = 0; i < num; i++) {
...
String String::substring(const int start, int end) const {
    if (string == NULL) return String("substring of an empty string");
    else if (start < 0 || start > length(string) || end < 0 || end > length(string)) return String("Invalid substring indices");
    else {
    if(end == 0) {
        end = length(string);
    }
...
String String::find(const char c) const {
    if (string == NULL) return String("finding in an empty string");
    else {
        for(size_t i = 0; i < length(string); i++) {
            if (string[i] == c) return substring(i);
        }
...
String String::find(const char * cstr) const {
    if (string == NULL) return String("finding in an empty string");
    else if (cstr == NULL) return String("finding an empty string");
    else {
    for(size_t j = 0; j < length(string); j++){    
...
String String::find(const String & str) const {
    if (string == NULL) return String("finding in an empty string");
    else if (str.string == NULL) return String("finding an empty string");
    else {
    for(size_t j = 0; j < length(string); j++){    
...
bool String::compare(const char * cstr) const {
    ...
    else if (cstr == NULL) return false;
    else if (length(string) != length(cstr)) return false;
    else {
    int flags = 0;
    for(size_t i = 0; i < length(cstr); i++) {
...
bool String::compare(const String & str) const {
    if (string == NULL) return false;
    else if (str.string == NULL) return false;
    else if (length(string) != length(str.string)) return false;
    else {
    int flags = 0;
    for(size_t i = 0; i < length(str); i++) {
